...
def settings():
    ...
    sim_config = SimulationConfig(
        ...
        side_sensor_distance_x=0.05,     # Horizontal distance from car center to side sensors in meters (left/right)
        side_sensor_distance_y=0.05,     # Vertical distance from car center to side sensors in meters (forward/backward)
        side_sensor_size=0.01,           # Side sensor diameter in meters
        # track generation configuration
        track_file_path="tracks/track_teste.tfg"  # Path to .tfg file
